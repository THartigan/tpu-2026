...
For checkpoint selection without frequent full evals, `train.py --save-best-eval-check-answer` force-saves an actor checkpoint whenever the lightweight eval `check_answer` reward reaches a new high.
